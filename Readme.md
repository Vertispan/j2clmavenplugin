...
-DarchetypeArtifactId=j2cl-maven-plugin \
-DarchetypeVersion=0.13-SNAPSHOT
```

Tip: if you don't have a pre-installed `j2cl-maven-plugin`, you can install it manually:
```
mvn org.apache.maven.plugins:maven-dependency-plugin:get \
-DrepoUrl=https://repo.vertispan.com/j2cl/ \
-Dartifact=com.vertispan.j2cl:j2cl-maven-plugin:0.13-SNAPSHOT
```
